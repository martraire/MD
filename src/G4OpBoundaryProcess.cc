...
// *                                                                      *
// * Date : 7 July 2015                                                   *
// * Author : Peter Gumplinger (October 2007)                             *
// * Modified : D. Martraire for LHAASO                                   *
// *                                                                      *
// * Description :                                                        *
// * This file implement the class of the optical photon boundary process *
// * Discrete Process as reflection/refraction at optical interfaces.     *
// ************************************************************************
...
// Constructors
G4OpBoundaryProcess::G4OpBoundaryProcess(const G4String& processName, G4ProcessType type)
...
G4OpBoundaryProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
  ...
  if (type == dielectric_metal) {
	...
	DoReflection();
      ...
      //charming change for AUGER TANK;
      if (Material2->GetName() == "HDPE") {
	if ( !G4BooleanRand(theReflectivity) ) DoAbsorption();
