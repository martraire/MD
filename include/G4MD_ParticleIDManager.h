...
#ifndef G4MD_ParticleIDManager_h
#define G4MD_ParticleIDManager_h 1

class G4MD_ParticleIDManager
{
  public:
...
G4String G4MD_ParticleIDManager::GetG4Name (G4int pid)
{
...
G4int G4MD_ParticleIDManager::GetCorsikaID (G4String pname)
{
